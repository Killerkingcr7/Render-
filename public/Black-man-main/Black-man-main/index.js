 const API_TOKEN = "n6rqpKj9hrdfbiM";
  ...
  async function connectWebSocket() {
    ...
    document.getElementById('loadingIndicator').style.display = 'block';
    document.getElementById('connectBtn').disabled = true;
    document.getElementById('connectBtn').innerHTML = '<i class="fas fa-spinner fa-spin"></i> Loading Historical Data...';
  ...
  function updateDisplay(lastDigit) {
    ...
    // Fixed percentage calculation to ensure they add up to 100%
    ...
    // Ensure rise/fall percentages add up to 100%
    const adjustedFallPercent = total > 1 ? (100 - parseFloat(risePercent.toFixed(1))).toFixed(1) : 0;
    ...
    document.getElementById('fallPercent').textContent = `${adjustedFallPercent}%`;

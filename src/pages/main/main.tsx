...
const AnalysistoolComponent = lazy(() => import('../../components/analysistool/analysis'));

// Simple DTrader fallback component
const DTrader = lazy(() => {
    return import('../dashboard/dtrader').catch((error) => {
        console.warn('Failed to load DTrader:', error);
        return {
            default: () => (
                <div style={{
                    display: 'flex',
                    ...
                    <div style={{ fontSize: '1rem', maxWidth: '500px', lineHeight: '1.6', color: '#666' }}>
                        The advanced trading interface is being prepared for you. In the meantime, you can use the Bot Builder to create automated trading strategies.
                    </div>
                    <div style={{ 
                        display: 'flex', 
                        gap: '1rem', 
                        ...
                        <button
                            onClick={() => console.log('Navigate to Bot Builder')}
                            style={{
                                padding: '12px 24px',
                                background: '#ff444f',
                                color: 'white',
    ...
    <statement name="AFTERPURCHASE_STACK">
      <block type="trade_again" id="trade_again_1" />
            ...
            if (window.Blockly?.derivWorkspace) {
                window.Blockly.derivWorkspace.strategy_to_load = bulkTradingBotXML;
            }
